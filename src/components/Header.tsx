...
const Header = () => {
	...
	return (
		<header className='sticky top-0 left-0 z-50 flex flex-col w-full md:px-4 md:pt-4 md:mx-auto bg-sweetAiran dark:bg-laborWorker md:place-content-center md:fade-bottom'>
