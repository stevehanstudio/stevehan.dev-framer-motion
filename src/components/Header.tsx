...
const Header = () => {
	...
	return (
		<header className='absolute top-0 left-0 z-50 flex flex-col w-full md:p-4 md:mx-auto bg-sweetAiran dark:bg-laborWorker md:place-content-center md:fade-bottom'>
